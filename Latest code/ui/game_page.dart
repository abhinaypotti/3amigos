...
import 'package:project/ui/field.dart';
import 'package:project/ui/game_presenter.dart';
      ...
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: Text("You are playing as X", style:TextStyle(color: Colors.black, fontSize: 30),),
          ),
           Expanded(
